...
class Xcom_Chronicle_Web_Product_UpdateConfigurableProductTest extends Xcom_Chronicle_TestCase
{
    protected $_productSku;
    /**
     * <p>Preconditions:</p>
     * <p>Log in to Backend.</p>
     * <p>Create a configurable product.</p>
     */
    public function setUpBeforeTests()
    {

        $this->loginAdminUser();
        $productData = $this->_createConfigurableProduct();
     ...
     * <p>Update Product</p>
     * <p>Preconditions:</p>
     * <p>1.A configurable product is created.</p>
     * <p>Steps:</p>
    ...
    public function updateProductDataProvider(){
        ...
        return array(
            "Update Configurable Product Name" => array($updateProductNameData, $updateProductDescriptionGeneratedMsgs,),
            "Update Configurable Product Short Description" => array($updateProductShortDescriptionData, $updateProductDescriptionGeneratedMsgs,),
            "Update Configurable Product Description" => array($updateProductDescriptionData, $updateProductDescriptionGeneratedMsgs,),
            "Update Configurable Product Sku" => array($updateProductSkuData, array(),),
            "Update Configurable Product Price" => array($updateProductPriceData, $updateProductPriceGeneratedMsgs,),
            "Update Configurable Product MSRP" => array($updateProductMsrpData, $updateProductMsrpMsgs,),
            "Update Configurable Product Out Of Stock" => array($updateProductInventoryOutOfStockData, array(),),
            "Update Configurable Product Url Key" => array($updateProductUrlKeyData, $updateProductUrlKeyGeneratedMsgs,),
        );
    }
