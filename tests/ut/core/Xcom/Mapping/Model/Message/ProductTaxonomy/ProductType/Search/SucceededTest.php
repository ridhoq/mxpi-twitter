 ...
 */
class Xcom_Mapping_Model_Message_ProductTaxonomy_ProductType_Search_SucceededTest extends Xcom_TestCase
{
    /** @var Xcom_Mapping_Model_Message_ProductTaxonomy_ProductType_Search_Succeeded */
    protected $_object;
    protected $_instanceOf = 'Xcom_Mapping_Model_Message_ProductTaxonomy_ProductType_Search_Succeeded';

    public function setUp()
    {
        parent::setUp();
        $this->_object = Mage::helper('xcom_xfabric')->getMessage('productTaxonomy/productType/searchSucceeded');
    }
