 ...
 */
class Xcom_Mapping_Model_Message_ProductTaxonomy_Get_RequestTest extends Xcom_TestCase
{
    /** @var Xcom_Mapping_Model_Message_ProductTaxonomy_ProductType_Search_Request */
    protected $_object;
    protected $_instanceOf = 'Xcom_Mapping_Model_Message_ProductTaxonomy_Get_Request';

    public function setUp()
    {
        parent::setUp();
        $this->_object = Mage::helper('xcom_xfabric')->getMessage('productTaxonomy/get');
