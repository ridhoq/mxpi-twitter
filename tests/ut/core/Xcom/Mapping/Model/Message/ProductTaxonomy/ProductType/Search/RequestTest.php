 ...
 */
class Xcom_Mapping_Model_Message_ProductTaxonomy_ProductType_Search_RequestTest extends Xcom_TestCase
{
    /** @var Xcom_Mapping_Model_Message_ProductTaxonomy_ProductType_Search_Request */
    protected $_object;
    protected $_instanceOf = 'Xcom_Mapping_Model_Message_ProductTaxonomy_ProductType_Search_Request';

    public function setUp()
    {
        parent::setUp();
        $this->_object = Mage::helper('xcom_xfabric')->getMessage('productTaxonomy/productType/search');
    ...
    public function testSchema()
    {
        ...
        $this->assertArrayHasKey('criteria', $messageData);
    ...
    public function testProcess()
    {
        $this->_disableSchema();
        $data = array(
            'product_class_id'      => 'test_criteria',
            'language'      => 'en',
            'country'       => 'US',
