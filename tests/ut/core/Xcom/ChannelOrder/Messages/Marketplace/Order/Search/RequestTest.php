<?php
class Xcom_ChannelOrder_Messages_Marketplace_Order_Search_RequestTest
        extends Xcom_TestCase
{
    /**
     * @var Xcom_ChannelOrder_Model_Message_Marketplace_Order_Search_Request
     */
    protected $_object;

    protected $_instanceOf = 'Xcom_ChannelOrder_Model_Message_Marketplace_Order_Search_Request';

    public function setUp()
    {
        parent::setUp();
        $this->_object = Mage::getModel('xcom_channelorder/message_marketplace_order_search_request');
    }
