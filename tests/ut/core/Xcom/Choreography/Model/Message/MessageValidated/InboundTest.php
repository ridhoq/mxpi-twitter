...
class Xcom_Choreography_Model_Message_MessageValidated_InboundTest extends Xcom_TestCase
{
    /** @var Xcom_Choreography_Model_Message_MessageReceived_Outbound */
    protected $_object;
    protected $_instanceOf = 'Xcom_Choreography_Model_Message_MessageValidated_Inbound';

    public function setUp()
    {
        parent::setUp();
        $this->_object = new Xcom_Choreography_Model_Message_MessageValidated_Inbound();
    }
    ...
    public function testProcess()
    {
        ...
        $messageMock = $this->mockModel('xcom_xfabric/message', array('setValidated'), true, array(array('db_adapter' => $requestMock)));
        $messageMock->expects($this->once())
            ->method($this->equalTo('setValidated'))
