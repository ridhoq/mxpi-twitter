...
class Xcom_Chronicle_Model_Message_Order_Return_Outbound extends Xcom_Xfabric_Model_Message_Request
{
    ...
    public function _prepareData(Varien_Object $dataObject = null)
    {
        ...
        $orderMessage = Mage::getModel('xcom_chronicle/message_order',
            array('order' => $dataObject->getOrder(), 'type' => 'simple'));

        $data = $orderMessage->getRecord('OrderReturn', array($dataObject->getCreditMemo()));
