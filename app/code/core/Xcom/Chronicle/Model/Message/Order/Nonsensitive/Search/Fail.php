...
class Xcom_Chronicle_Model_Message_Order_Nonsensitive_Search_Fail extends Xcom_Xfabric_Model_Message_Request
{
    protected function _construct()
    {
        parent::_construct();
        $this->_topic = 'com.x.ordermanagement.v2/OrderSearch.NonSensitive/SearchOrderFailed';
