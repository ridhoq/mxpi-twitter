...
class Xcom_Chronicle_Model_Message_Customer_Search_Email_Success extends Xcom_Xfabric_Model_Message_Request
{
    protected function _construct()
    {
        parent::_construct();
        $this->_topic = 'com.x.customer.v1/CustomerSearch.Email/SearchEmailCustomerSucceeded';
        $this->_schemaRecordName = 'SearchEmailCustomerSucceeded';
