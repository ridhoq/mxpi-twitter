...
class Xcom_Chronicle_Model_Message_Customer_Get_Success extends Xcom_Xfabric_Model_Message_Request
{
    protected function _construct()
    {
        parent::_construct();
        $this->_topic = 'com.x.customer.v1/CustomerLookup/LookupCustomerSucceeded';
        $this->_schemaRecordName = 'LookupCustomerSucceeded';
    ...
    public function _prepareData(Varien_Object $dataObject = null)
    {
        ...
        $returnRequest = parent::_prepareData($dataObject);
