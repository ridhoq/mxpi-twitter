...
class Xcom_Chronicle_Model_Message_Customer_Get_Fail extends Xcom_Xfabric_Model_Message_Request
{
    protected function _construct()
    {
        parent::_construct();
        $this->_topic = 'com.x.customer.v1/CustomerLookup/LookupCustomerFailed';
        $this->_schemaRecordName = 'LookupCustomerFailed';
