...
class Xcom_Chronicle_Model_Message_Webstore_Offer_Quantityupdated_Outbound extends Xcom_Xfabric_Model_Message_Request
{
    ...
    public function _prepareData(Varien_Object $dataObject = null)
    {
        ...
        $data = array(
            ...
            'quantity' => $avroDataObject->getQuantity(),
