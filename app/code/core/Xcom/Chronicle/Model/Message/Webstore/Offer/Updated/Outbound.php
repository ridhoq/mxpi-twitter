...
class Xcom_Chronicle_Model_Message_Webstore_Offer_Updated_Outbound  extends Xcom_Xfabric_Model_Message_Request
{
    protected function _construct()
    {
        parent::_construct();
        $this->_topic = 'com.x.webstore.v1/WebStoreOfferUpdate/WebStoreOfferUpdated';
        $this->_schemaRecordName = 'WebStoreOfferUpdated';
