...
class Xcom_Chronicle_Model_Message_Webstore_Offer_Priceupdated_Outbound extends Xcom_Xfabric_Model_Message_Request
{
    protected function _construct()
    {
        parent::_construct();
        $this->_topic = 'com.x.webstore.v1/WebStoreOfferUpdate/WebStoreOfferPriceUpdated';
    ...
    public function _prepareData(Varien_Object $dataObject = null)
    {
        ...
        $data = array(
            ...
            'currentPrice' => $avroDataObject->createPrice(),
            'webStoreId' => $avroDataObject->getWebStoreId(),
        );
